...
def abrir_horario(request):
    if not is_medico(request.user):
        messages.add_message(request, constants.WARNING,'Somente médicos podem abrir horario pra consulta!')
...
def consulta_area_medico(request, id_consulta):
    ...
    if request.method == "GET":
        ...
        return render(request, 'consulta_area_medico.html', {'documentos':documentos,'consulta': consulta,'is_medico': is_medico(request.user)}) 
    elif request.method == "POST":
